  ...
  return (
    <>
      ...
      <img
        ...
        className="h-64 w-64 self-center mb-28"
      />

      <PenjelasanKecil
        judul="Halo Semuanya ~"
        isi="Namaku adalah Abdul Haris Halim, biasanya teman temanku memanggilku Halim. Aku adalah seorang Mahasiswa yang sedang menjalani kuliah di Universitas Brawijaya."
      />
      ...
      <PenjelasanKecil
        ...
        isi="Dibawah ini adalah hasil kerjaku sejak aku memulai mempelajari design dan front-end website developer"
      />
      ...
      <div className="flex flex-col lg:flex-row items-center mb-24 md:mb-48 xl:mx-32">
        <div className="pb-12 lg:pb-0">
          <h1 className="text-center lg:text-left text-2xl xl:text-3xl uppercase font-bold font-coba mx-12 sm:mx-0 pb-2 md:pb-0">
            Tertarik untuk bekerja bersama?
          </h1>
          <p className="text-center lg:text-left text-lg sm:text-xl font-coba font-light mx-12 sm:mx-0 lg:w-5/6">
            Aku selalu tertarik untuk bekerja dibidangku dimanapun itu, apabila
            aku dapat membantu hubungi saja langsung{" "}
          </p>
        </div>
