...
function App() {
  ...
  return (
    <main className="bg-whitebrown sm:px-32 lg:px-60 flex flex-col px-0">
      <Nav/>
      {/* Hero */}
      ...
      <div className='flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-12 mb-36'>
        ...
        <SkillCard Tools={[images['reactLogo.png'],images['tailwindlogo.png'],images['JSlogo.png']]} Logo={images['Designer_logo.png']} Judul="UI/UX DESIGNER" Desc="Aku dapat membuat struktur konten, design pattern, dan design interaksi dalam sebuah aplikasi berbasis website"/>
      </div>
      {/* Skill End */}
      ...
      <div className='grid grid-cols-1 sm:grid-cols-3 mx-12 sm:mx-24 gap-8 mb-48 auto-rows-[minmax(200px,200px)] sm:auto-rows-[minmax(300px,300px)]'>
      ...
      {/* Contact Me */}
      <div className='flex flex-col sm:flex-row items-center mb-24 sm:mb-48 sm:mx-32'>
        <div className='pb-8 sm:pb-0'>
          <h1 className='text-center sm:text-left text-2xl sm:text-3xl uppercase font-bold font-coba mx-12 sm:mx-0 pb-2 sm:pb-0'>Tertarik untuk bekerja bersama?</h1>
          <p className='text-center sm:text-left text-lg sm:text-xl font-coba font-light mx-12 sm:mx-0 sm:w-5/6'>Aku selalu tertarik untuk bekerja dibidangku dimanapun itu, apabila aku dapat membantu hubungi saja langsung </p>
        </div>
        <button className='w-max h-min text-xs sm:text-base rounded-xl border-4 border-blackbrown font-semibold hover:text-whitebrown hover:bg-darkbrown hover:border-darkbrown py-4 px-6 font-coba flex items-center'>
          <BiMessageDetail className='text-2xl sm:text-5xl'/>
